...
void Engine::createVertexBuffer(VkBuffer& buffer, VkDeviceMemory& bufferMemory, const std::vector<Vertex>& bufferData) {
...
void Engine::createIndexBuffer(VkBuffer& buffer, VkDeviceMemory& bufferMemory, const std::vector<uint32_t>& bufferData) {
	VkDeviceSize bufferSize = sizeof(bufferData[0]) * bufferData.size();
