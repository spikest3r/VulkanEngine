...
void Engine::createTextureImageView(VkImageView& textureImageView, VkImage& textureImage) {
	textureImageView = createImageView(textureImage, VK_FORMAT_R8G8B8A8_SRGB, VK_IMAGE_ASPECT_COLOR_BIT);
}

void Engine::createTextureImage(const char* texName, VkImage& texture, VkDeviceMemory& texMem) {
	...
	if (!pixels) {
		...
		snprintf(errorBuffer, 1024, "Failed to load texture image %s", texName);
	...
	createImage(texWidth, texHeight, VK_FORMAT_R8G8B8A8_SRGB, VK_IMAGE_TILING_OPTIMAL, VK_IMAGE_USAGE_TRANSFER_DST_BIT | VK_IMAGE_USAGE_SAMPLED_BIT, VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT, texture, texMem);
